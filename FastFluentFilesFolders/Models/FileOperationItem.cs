...
namespace FastFluentFilesFolders.Models
{
    public class FileOperationItem : INotifyPropertyChanged
    {
        ...
        public int FileCount { get => _fileCount; set { if (_fileCount != value) { _fileCount = value; Notify(); } } }
        public string Process { get => _process; set { if (_process != value) { _process = value; Notify(); } } }
        public string RemainTime { get => _remainTime; set { if (_remainTime != value) { _remainTime = value; Notify(); } } }
        public string SizeText { get => _sizeText; set { if (_sizeText != value) { _sizeText = value; Notify(); } } }
